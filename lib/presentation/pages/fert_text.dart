...
class FertText extends StatefulWidget {
  const FertText({super.key});

  @override
  State<FertText> createState() => _FertTextState();
}

class _FertTextState extends State<FertText> {
  @override
              ...
              children: [
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    ...
                    child: Image.asset('assets/images/chickfert5.png'),
                  ),
                ),
                SizedBox(height: 24),
